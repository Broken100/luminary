...
const faqs = [
  ...
  },
  {
    ...
    answer: "Es esencial para asegar que los productos no representen un riesgo para la salud pública y para poder operar comercialmente dentro del marco legal, evitando sanciones y clausuras."
  },
  {
